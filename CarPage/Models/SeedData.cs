        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
                ...
                serviceProvider.GetRequiredService<DbContextOptions<CarContext>>()))
            {
                ...
                context.Cars.AddRange(
                    ...
                    new Car { Make = "BMW", Model = "X5", Year = 2020, Price = 40000, Description = "Luxury and performance. Perfect for long drives.", ImageUrl = "/images/bmw.jpg", VehicleStatus = "Brand New", Transmission = "Automatic", FuelType = "Gasoline", Color = "Blue", EnginePower = "250 HP" },
                    new Car { Make = "Audi", Model = "A4", Year = 2019, Price = 30000, Description = "Elegant and efficient. A blend of style and performance.", ImageUrl = "/images/audi.jpg", VehicleStatus = "Second Hand", Transmission = "Automatic", FuelType = "Diesel", Color = "White", EnginePower = "190 HP" },
